...
# Objective 2
conversionValue = openpyxl.load_workbook('conversion.xlsx', data_only=True)
conversion_transposed = conversionValue.worksheets[1]

database = openpyxl.load_workbook('database.xlsx')
database_sheet = database.active

transposed_range = conversion_transposed['C6:F8']
print(conversion_sheet['D7'].value)
